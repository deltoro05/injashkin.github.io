...
В статье подробно описывается настройка сборщика Webpack 5. Слово "подробно" означает, что здесь будут, по возможности, объясняться все непонятные моменты в настройках.

> Многие руководства по настройке Webpack 5 объясняют, что делать, не не объясняют, зачем это надо. К тому же, в этих руководствах многие шаги опускают, с расчетом на осведомленность читателя.
