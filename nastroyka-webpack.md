...
Все шрифты нашего проекта будут располагаться в каталоге `src/fonts/`, поэтому, создадим этот каталог. Также, создадим в этом каталоге файл `fonts.scss`, в котором будем хранить CSS стили для шрифтов. Сразу импортируем данный файл в `main.scss`:
...
Обычно, рекомендуется оптимизировать шрифты, сжимая их на таких сервисах как [Font2web](https://www.font2web.com/) или [Transfonter](https://transfonter.org/), но шрифты от Google уже оптимизированы.
