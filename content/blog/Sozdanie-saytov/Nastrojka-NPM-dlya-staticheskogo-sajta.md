...
Для этого, в каталоге `src/pages` создадим каталог `article`, в котором создайте файл `index.pug` со следующим содержимым:
